  ...
  return (
    <div className="space-y-10 max-w-3xl">
      <div>
        ...
        <p className="text-sm text-chalk/60">NFL 33 Point Pool</p>
      </div>
      ...
      <div className="felt-panel rounded-xl p-5 space-y-2">
        ...
        <p className="text-base text-chalk/90 leading-relaxed">
          ...
          <span className="font-mono text-mustard font-bold">33</span> points, you win the pot.
        </p>
      ...
      <Section title="Entry Fee">
        <div className="grid sm:grid-cols-3 gap-3">
          <div className="stat-card p-4">
            <div className="font-mono text-3xl text-mustard font-bold">$100</div>
            <div className="text-[11px] uppercase tracking-wider text-chalk/50">Total entry</div>
          </div>
          <div className="stat-card p-4">
            <div className="font-mono text-3xl text-chalk/90 font-bold">$90</div>
            <div className="text-[11px] uppercase tracking-wider text-chalk/50">
              Weekly pots — $5 × 18 weeks
            </div>
          </div>
          <div className="stat-card p-4">
            <div className="font-mono text-3xl text-chalk/90 font-bold">$10</div>
            <div className="text-[11px] uppercase tracking-wider text-chalk/50">Season awards</div>
          </div>
        </div>
      </Section>
      ...
      <Section title="Weekly Rules">
        <ul className="space-y-2">
          ...
          <Rule>
            ...
            <span className="font-mono text-mustard font-semibold">33</span> points, you win the pot.
          </Rule>
          <Rule>If more than one team scores 33 in the same week, the pot is split evenly.</Rule>
          <Rule>If nobody scores 33, the pot carries over to the following week.</Rule>
      ...
      <Section title="Weekly Payouts">
        <ul className="space-y-2">
          <Rule>
            Base pot is <span className="font-mono text-mustard font-semibold">$160</span> per week
            — $5 × 32 members.
          </Rule>
        ...
        <div className="stat-card p-4 space-y-1">
          ...
          <p className="text-sm text-chalk/80 leading-relaxed">
            No team hits 33 in weeks 1 through 4. Week 5's pot is{' '}
            <span className="font-mono text-mustard font-bold">$800</span> — $640 carried over from
            the first four weeks, plus $160 for week 5.
          </p>
        </div>
        ...
        <div className="rounded-lg border border-mustard/40 bg-mustard/10 p-4 space-y-1">
          ...
          <p className="text-sm text-chalk/85 leading-relaxed">
            Nothing carries into the next season, so week 18 has a winner no matter what. If no team
            lands on 33, the pot goes to whoever finishes closest. Above or below doesn't matter — a
            team at 32 and a team at 34 are equally close, and would tie and split. Any tie splits
            evenly.
          </p>
          <p className="text-xs text-chalk/50 pt-1">
            These show up in the Winners table tagged <span className="font-mono">Wk18</span> rather
            than <span className="font-mono">33</span>, so they count toward money won without
            counting as a career 33-hit.
          </p>
        </div>
      </Section>
      ...
      <Section title="Season Awards">
        <p className="text-sm text-chalk/70 leading-relaxed">
          Every week, your differential is how far your team's score landed from 33 — above or below,
          it counts the same. Those add up across the season.
        </p>
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          ...
          <div className="stat-card p-4 space-y-1">
            ...
            <div className="text-xs text-chalk/60">
              Highest cumulative differential. {money(AWARD_PAYOUT.best)} less the $20 website fee.
            </div>
          </div>
        </div>
        ...
        <ul className="space-y-2">
          <Rule>
            No ties on season awards. The tiebreaker is the lower or higher differential in week 18.
            Still tied, it goes back to week 17, then week 16, and so on.
          </Rule>
          <Rule>
            Running differentials are on the <span className="text-mustard">Live Season Tracker</span>{' '}
            during the season, and finalized on the{' '}
            <span className="text-mustard">Season Awards</span> page once it closes.
          </Rule>
        </ul>
      </Section>
